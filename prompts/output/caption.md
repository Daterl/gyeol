...
evidence에는 해당 photo_id를 ref로 하는 uploaded_photo 근거를 포함하고, 비어 있지 않은 note에 사용한 실제 사실을 짧게 적는다. 프로필의 말투를 사진 내용의 증거로 대신하지 않는다. 근거 없는 Claim이나 빈 evidence를 보내지 않는다.
