...
사진 묶음에서 확인한 공통 사실이나 사진을 놓은 행위를 짧게 부른다. 슬롯의 describable_facts 밖에 있는 장소·날짜·인물·기분을 제목으로 도입하지 않는다. **사진 한 장에 찍힌 글귀·숫자·광고 문구를 제목으로 옮기지 않는다.** 한 장에만 있는 말은 묶음 전체의 사실이 아니며, 다섯 자 이상 이어진 발췌는 띄어쓰기를 지워도 거부되고, 사진 글귀에 있던 두 자 이상의 숫자도 거부된다. 공통 소재를 확인할 수 없으면 “사진을 잇는 순서”처럼 중립적인 제목이 가능하다.
