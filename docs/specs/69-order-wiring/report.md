...
> **기록 경계:** 이 본문은 `531b134`를 기준으로 한 PR #75 최초 구현·측정 스냅샷이다. 최신 인수 판정은 [`fix-report.md`](./fix-report.md)와 PR #75 최종 커밋 `a2c8f43004e18cb65d48f7afc1048e3273de1b47`을 기준으로 한다.
...
## 6. `531b134` 기반 최초 측정에서 발견한 차단 — #79에서 해결됨
...
아래 192건은 `531b134` 기반 PR #75 최초 구현의 실행 결과다. PR #75 최종 커밋의 최신 인수 결과는 `fix-report.md`의 **195/195 통과**를 따른다.
