...
편집 화면은 최대 480px로 가운데 놓고 공유 화면은 최대 935px까지 확장한다. 360·390·430px에서는 3열을 유지하며, 하단 확정 행동이 키보드와 safe area에 가려지지 않아야 한다. 사진 상세는 전체 화면 dialog로 열고 닫기·이전·다음에 이름과 키보드 조작을 제공한다.
