...
export function validateOmission(omission, slots) {
  ...
  text(omission.note,'omission.note',200);
  requireValue(Array.isArray(omission.evidence) && omission.evidence.some(e=>e?.kind==='rule' && e.ref===OMISSION_RULE),'omission.evidence','missing the counting rule');
  return omission;
}
