...
const ROLE = {
  ...
  // 자리를 정했다. 그 규칙을 사용자 말로 그대로 말한다 — 인접 대비를 덧붙이면 진짜 이유가 흐려진다.
  turn: {tail: '남은 사진 중 색이 가장 짙어 여기서 분위기가 한 번 바뀌어요.'},
  closer: {tail: '남은 사진 중 가장 어두워 마지막을 차분하게 닫아요.'}
};
