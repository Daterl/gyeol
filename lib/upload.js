...
export async function validateUpload(value) {
  ...
  const allowed=['schema_version','photo_id','input_index','file_ref','media_type','image_base64'];
  ...
  return {bytes,photoId:value.photo_id,inputIndex:value.input_index,fileRef:value.file_ref,mediaType:value.media_type};
}
